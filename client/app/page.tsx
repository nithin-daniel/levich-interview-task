        ...
        <main className="flex-1 overflow-auto px-4 pb-4 md:p-6">
          <div className="max-w-7xl mx-auto space-y-4 md:space-y-6">
            <div className="hidden lg:flex items-center justify-between">
              <h1 className="text-2xl font-semibold text-foreground">Welcome back, Olivia</h1>
            ...
            <div className="lg:hidden">
              <h1 className="text-xl font-semibold text-foreground mb-3">Welcome back, Olivia</h1>
